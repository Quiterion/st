 ...
 */
static char *font = "Hack Nerd Font Mono:pixelsize=14:antialias=true:autohint=false";
static char *font2[] = { "Inconsolata for Powerline:pixelsize=14:antialias=true:autohint=false" };
